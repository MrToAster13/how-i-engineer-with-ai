...
- **[GRC Fleet Auditor](case-studies/grc-fleet-auditor.md)** (flagship) — a CIS compliance auditor for a fleet of Ubuntu hosts, built to never certify a host it didn't actually assess. 148 tests, CI, a real security-hardening arc. Code: [`MrToAster13/grc-fleet-scanner`](https://github.com/MrToAster13/grc-fleet-scanner).
